...
RUN \
    ...
    pacman -S --noconfirm awk aws-cli binutils docker docker-compose fakeroot fcitx-im fcitx-mozc file git jshon lxqt neofetch openbox openssh otf-ipafont tar tigervnc tmux vim wget zsh; \
